...
const OurClient = () => {
  const { ref, inView } = useInView({
    ...
    threshold: 0.5, // Set the threshold for triggering the animation
  });
  return (
    <div ref={ref}>
      <motion.div
        ...
        <div className="space-y-3 py-5 max-w-screen-xl	 mx-auto md:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 pt-8 gap-6">
            ...
            <div className="p-4 shadow rounded bg-white space-y-3 hover:shadow-xl transition-all">
              <p className="text-justify text-gray-400">
                {" "}
                <span className="text-5xl text-[#4CCE5B] font-bold">
                  “
                </span>{" "}
                Begin by ensuring that you fully understand the client's
                request. Ask for detailed information, including the type of
                content or services they need, their specific requirements,
                deadlines, and any other relevant details.
              </p>
              <div className="flex justify-start items-center gap-5">
                <img
                  className="w-[50px] border rounded-full"
            ...
            <div className="p-4 shadow rounded bg-white space-y-3 hover:shadow-xl transition-all">
              <p className="text-justify text-gray-400 ">
                ...
                Discuss the terms of the engagement, including pricing, payment
                terms, milestones, and any contractual agreements. It's crucial
                to have a clear understanding of expectations and ensure both
